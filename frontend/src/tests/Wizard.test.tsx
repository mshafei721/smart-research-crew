...
describe("Wizard Component", () => {
  ...
  it("renders initial wizard form", () => {
    render(
      <Wizard setSections={mockSetSections} setReportMd={mockSetReportMd} />,
    );
    ...
    expect(
      screen.getByRole("button", { name: /launch research/i }),
    ).toBeInTheDocument();
  });
    ...
    if (topicInput && guidelinesInput) {
      ...
      await waitFor(() => {
        ...
        const progressElements = screen.queryAllByText(
          /loading|progress|researching/i,
        );
    ...
    if (topicInput) {
      ...
      if (submitButton && !submitButton.disabled) {
        ...
        await waitFor(() => {
          ...
          const sectionElements = screen.queryAllByText(
            /introduction|completed/i,
          );
  ...
  it("allows user to restart research process", async () => {
    ...
    if (topicInput) {
      ...
      const restartButtons = screen.queryAllByText(
        /new|reset|start over|back/i,
      );
  ...
  it("handles different section configurations", async () => {
    ...
    const sectionInputs =
      screen.queryAllByRole("checkbox") || screen.queryAllByRole("textbox");
