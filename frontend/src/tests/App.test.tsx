...
describe('App Component', () => {
  ...
  it('displays the application title or branding', () => {
    ...
    const titleElements = screen.queryAllByText(/smart research|research crew|src/i)
  ...
  it('initializes in the correct default state', () => {
    ...
    const wizardElements = screen.queryAllByText(/topic|research|guidelines|start/i)
